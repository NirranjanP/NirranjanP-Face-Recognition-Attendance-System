                ...
                with col2:
                            ...
                            if True:
                                ...
                                while True:
                                    ...
                                    if press:
                                        cv2.imwrite(os.path.join(r"C:\Users\ajjuk\Downloads\proj\Face-Recognition-Attendance-System-main-main\Face-Recognition-Attendance-System-main-main\pages\student_images", register_number+".jpg"), cv2.cvtColor(frame, cv2.COLOR_BGR2RGB))
                                        break
